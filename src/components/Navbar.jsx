  ...
  return (
    <div className='overflow-x-hidden'>
      <header className='bg-white text-black relative w-full'>
        <nav className='flex flex-row justify-between max-sm:text-sm max-sm:hidden'>
          <ul className='flex flex-row max-sm:flex max-sm:items-center max-sm:justify-center'>
            ...
            <li className='px-2 cursor-pointer'><Link to='/basket'>basket</Link></li>
          </ul>
          <div>
      ...
      <div className='sm-size text-right py-4 pr-4 md:hidden overflow-hidden h-full z-10'>
        <button onClick={navbarHandler} className='active:scale-95 transition-all active:duration-100'>
        ...
        <div className=' fixed -right-full top-0 w-[40%] h-full z-10 bg-white transition-all dark:bg-cyan-900 dark:text-white' ref={navRef}>
          ...
          <ul className='flex flex-col py-5 text-lg uppercase mt-5'>
            <li onClick={navbarHandler} className='px-2 cursor-pointer my-3 active:text-gray-500'><Link to='/'>Home</Link></li>
            <li onClick={navbarHandler} className='px-2 cursor-pointer my-3 active:text-gray-500'><Link to='/services' >services</Link></li>
            <li onClick={navbarHandler} className='px-2 cursor-pointer my-3 active:text-gray-500'><Link to='/about-us' >about us</Link></li>
            <li onClick={navbarHandler} className='px-2 cursor-pointer my-3 active:text-gray-500'><Link to='/contact-us'>contact us</Link></li>
            <li onClick={navbarHandler} className='px-2 cursor-pointer my-3 active:text-gray-500'><Link to='/shopping'>shopping</Link></li>
            <li onClick={navbarHandler} className='px-2 cursor-pointer my-3 active:text-gray-500'><Link to='/basket'>basket</Link></li>
          </ul>
        </div>
      </div>
    </div>
